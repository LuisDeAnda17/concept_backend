...
content_id: 4e6df42a6c2085edeeb7cbde6e5660f203b71b63478272ddd8ee76a4cd23b88d
---

# Updated `BrontoBoardConcept.ts` with additional queries
...
export default class BrontoBoardConcept {
   ...
   * @returns An array of AssignmentDoc for the given class.
   */
   ...
   * @param input An object containing the class ID.
   *   - `class`: The ID of the class.
   * @returns An array of OfficeHourDoc for the given class.
   */
   ...
   * @returns An array of ClassDoc for the given BrontoBoard.
   */
   ...
   * @returns An array of BrontoBoardDoc owned by the given user.
   */
   ...
   * @returns An array containing the AssignmentDoc if found, otherwise empty.
   */
